...
async function getFilm(min, max) {
    for (let i = min; i < max; i++) {
        await fetch('https://api.themoviedb.org/3/movie/' + i + '?api_key=16eb18763928632ac96b6291fa839732&language=en-US')
...
async function getFilters() {
    await fetch('https://api.themoviedb.org/3/genre/movie/list?api_key=16eb18763928632ac96b6291fa839732&language=en-US')
        .then(result => result.json())
        .then(data => {
...
async function filterFilm(e) {
    ...
    let number = 20
    fetch('https://api.themoviedb.org/3/discover/movie?api_key=16eb18763928632ac96b6291fa839732&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_genres=' + selectedGenre + '&with_watch_monetization_types=flatrate')
